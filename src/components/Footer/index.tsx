    ...
    <footer className={styles.footer}>
      ...
      <div className={styles.info}>
        ...
        <div className={styles.opensea}>
          ...
          <div className={styles.links}>
            <div className={styles.linkcontainer}>
              <p className={styles.linktitle}>Marketplace</p>
              <ul>
                <li>
                  <a>All NFTs</a>
                </li>
            ...
            <div>
              <div className={styles.linkcontainer}>
                <p className={styles.linktitle}>My Account</p>
                <ul>
                  <li>
                    <a>Profile</a>
                  </li>
              ...
              <div className={styles.linkcontainer}>
                <p className={styles.linktitle}>Stats</p>
                <ul>
                  <li>
                    <a>Rankings</a>
                  </li>
        ...
        <div className={styles.end}>
          <p className={styles.credit}>© 2018 - 2022 Ozone Networks, Inc</p>
